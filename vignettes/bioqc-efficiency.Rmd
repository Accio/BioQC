...
1. use the approximative WMW-statistic (Zar, J. H. (1999). Biostatistical analysis. Pearson Education India. *pp.* 174-177). The differences are negligible for high-throughput gene expression data. 
